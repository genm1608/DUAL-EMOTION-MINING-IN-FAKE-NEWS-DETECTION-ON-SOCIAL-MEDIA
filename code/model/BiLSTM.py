# -*- coding: utf-8 -*-
from keras.layers import Input, Embedding, Bidirectional, LSTM, GlobalAveragePooling1D
...
class EmotionEnhancedBiLSTM:
    def __init__(self, max_sequence_length, embedding_matrix, emotion_dim=0, category_num=2, hidden_units=32, l2_param=0.01, lr_param=0.001):
        ...
        self.hidden_units = hidden_units # Số đơn vị ẩn của LSTM
    ...
    def build(self):
        ...
        # Thay GRU bằng LSTM
        lstm = Bidirectional(
            LSTM(self.hidden_units, return_sequences=True))(semantic_emb)
